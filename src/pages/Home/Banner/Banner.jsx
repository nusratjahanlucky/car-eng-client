        ...
        <div>
            <div className="carousel w-full h-[600px]">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute roundexd-xl h-full flex items-center bottom-0 left-0 top-0  bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                        <div className="text-white space-y-7 w-1/2 pl-12">
                            <h2 className="text-6xl font-bold">Affordable Price For Car Servicing</h2>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus labore exercitationem error est, quae consequatur.</p>
                            <div>
